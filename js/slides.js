(function($){
	...
	$.fn.slides.option = {
		...
		preloadImage: null,                // preloader的加载图像的名称和位置. 默认为 "/img/loading.gif"
		container: 'con',                  // 幻灯片容器类的名称. 默认为 "slides_container"
		generateNextPrev: false,            // 自动生成下一个/上一个按钮
		next: 'next',                        // 下一个按钮的类名
		prev: 'prev',                        // 上一个按钮的类名
		pagination: false,                   // 如果你不使用分页，您可以设置为false
		...
		fadeEasing: '',                      // 扩展jQuery的插件前必须加载 
		slideSpeed: 350,                     // 设定的速度以毫秒为单位的滑动动画
		slideEasing: '',                     // 扩展jQuery的插件前必须加载 
